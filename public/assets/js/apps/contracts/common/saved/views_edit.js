define(["../../../../app", "tpl!apps/contracts/common/templates/form_edit.html", "backbone.syphon"],
       function(AppManager, formTpl){
  AppManager.module("ContractsApp.Common.Edit.Views", function(Views, AppManager, Backbone, Marionette, $, _){
    Views.Form = Marionette.ItemView.extend({
      ...
      onFormDataInvalid: function(errors){
        ...
        var markErrors = function(value, key){
          ...
          var $errorEl = $("<span>", { class: "help-inline error text-danger", text: value });
  ...
  return AppManager.ContractsApp.Common.Edit.Views;
});
