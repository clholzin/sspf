define(["app",
        ...
        "tpl!apps/reports/list/templates/panel.html",
        "tpl!apps/reports/list/templates/none.html",
        "tpl!apps/reports/list/templates/list.html",
        "tpl!apps/reports/list/templates/list_item.html"],
       function(AppManager, layoutTpl, panelTpl, noneTpl, listTpl, listItemTpl){
  AppManager.module("ReportsApp.List.View", function(View, AppManager, Backbone, Marionette, $, _){
    View.Layout = Marionette.LayoutView.extend({
      template: layoutTpl,

      regions: {
        panelRegion: "#panel-region",
        reportsRegion: "#contacts-region"
      },
        onShow:function(){
    ...
    View.Panel = Marionette.ItemView.extend({
      ...
      triggers: {
        "click button.js-new": "report:new"
      },
    ...
    var NoReportsView = Marionette.ItemView.extend({
      template: noneTpl,
      tagName: "tr",
      className: "alert"
    });

    View.Reports = Marionette.CompositeView.extend({
      tagName: "table",
      className: "table table-hover",
      template: listTpl,
      emptyView: NoReportsView,
  ...
  return AppManager.ReportsApp.List.View;
});
