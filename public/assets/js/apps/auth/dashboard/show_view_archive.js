define(["app",
        ...
        "tpl!apps/auth/dashboard/templates/left_side.html",
        "tpl!apps/auth/dashboard/templates/left_item.html",
        "tpl!apps/auth/dashboard/templates/left_side_top.html",
        "tpl!apps/auth/dashboard/templates/right_side.html",
        "tpl!apps/auth/dashboard/templates/right_item.html",
        "tpl!apps/auth/dashboard/templates/missing.html",
        "tpl!apps/auth/dashboard/templates/view.html",
        "tpl!apps/auth/dashboard/templates/exportView.html",
        "tpl!apps/auth/dashboard/templates/category/guidList.html",
        "tpl!apps/auth/dashboard/templates/category/altList.html",
        "tpl!apps/auth/dashboard/templates/category/dpsList.html",
    ...
    function(AppManager,layoutTpl,leftSide,leftItem,topLeft,rightSide,
        ...
        AppManager.module("ContractsApp.Show.View", function(View, AppManager, Backbone, Marionette, $, _){
            ...
            View.Regions = Marionette.LayoutView.extend({
                template: layoutTpl,
                regions: {
                    leftRegion: "#top-panel",
                    mainRegion: "#main-panel",
                    rightRegion: "#bottom-panel",
                    topLeftRegion:"#top-top-panel"
                },
                onShow:function(){
            ...
            View.Left = Marionette.ItemView.extend({
                ...
                onRender:function(){
                  //  this.trigger("action:popover",this);
                        ...
                        this.$el.find('.datapicker').kendoCalendar();
                },
